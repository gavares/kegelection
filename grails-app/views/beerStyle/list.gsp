...
<html>
	...
	<body>
		<a href="#list-beerStyle" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-beerStyle" class="content scaffold-list" role="main">
			...
			<div class="pagination">
				<g:paginate total="${beerStyleInstanceTotal}" />
			</div>
		</div>
	</body>
</html>
